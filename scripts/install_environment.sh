...
#    sudo chmod +x /usr/bin/swtpm_setup
    sudo dnf install -y git socat autoconf automake libtool openssl-devel libtasn1-devel libtpms libtpms-devel json-glib json-glib-devel expect python3 libseccomp-devel tpm2-pkcs11 tpm2-pkcs11-tools tpm2-tools tpm2-abrmd gnutls-utils trousers gnutls gnutls-devel
