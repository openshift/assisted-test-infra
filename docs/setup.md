...
`setup` `Make` performs all of the operations required to take a fresh machine and prepare it for test infra operations. It performs three main operations to prepare the machine for running all available flows:
