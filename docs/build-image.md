...
This project uses `skipper` for excuting some of its operations inside containers. It is configured to work with an already built image `assisted-test-infra:latest`. To build the image, run:
