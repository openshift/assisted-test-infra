...
class Cluster(BaseCluster):
    ...
    def set_network_params(self, controller=None):
        ...
        if self._config.platform in [consts.Platforms.NONE, consts.Platforms.EXTERNAL]:
            ...
            if self._config.platform == consts.Platforms.BARE_METAL:
                log.info("User managed load balancer with bare metal platform, Setting the VIPs to the fixed load balancer IP")
                ...
                log.info("User managed load balancer with vsphere platform, Setting the VIP and machine networks to the provided configuration")
