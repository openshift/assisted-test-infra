...
MCE_VALIDATION_TIMEOUT = 10 * MINUTE
LVM_VALIDATION_TIMEOUT = 10 * MINUTE
READY_TIMEOUT = 15 * MINUTE
DISCONNECTED_TIMEOUT = 10 * MINUTE
PENDING_USER_ACTION_TIMEOUT = 45 * MINUTE
ERROR_TIMEOUT = 15 * MINUTE
...
DEFAULT_CLUSTER_NETWORKS_IPV6V4 = DEFAULT_CLUSTER_NETWORKS_IPV6 + DEFAULT_CLUSTER_NETWORKS_IPV4
DEFAULT_SERVICE_NETWORKS_IPV6V4 = DEFAULT_SERVICE_NETWORKS_IPV6 + DEFAULT_SERVICE_NETWORKS_IPV4
...
DEFAULT_CONFIGMAP = "assisted-service-config"
DEFAULT_AI_BASE_VERSION = "v2.15.0"
DEFAULT_DEPLOYMENT_SERVICE = "assisted-service"
...
DEFAULT_LOAD_BALANCER_NETWORK_CIDR = "192.168.1.0/24"
