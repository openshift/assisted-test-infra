...
DEFAULT_PRIMARY_STACK: str = consts.PrimaryStack.ipv4
DEFAULT_UEFI_BOOT_FIRMWARE: str = "/usr/share/OVMF/OVMF_CODE.fd"
DEFAULT_UEFI_BOOT_TEMPLATE: str = "/usr/share/OVMF/OVMF_VARS.fd"
DEFAULT_UEFI_BOOT: bool = False
