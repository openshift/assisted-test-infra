...
@pytest.fixture()
def api_client(env):
    yield get_api_client(env)


def get_api_client(env, offline_token=None, **kwargs):
    if offline_token is None:
        offline_token = env["offline_token"]

    url = env['remote_service_url']
