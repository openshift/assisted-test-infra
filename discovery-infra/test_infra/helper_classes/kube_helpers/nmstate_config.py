...
class NMStateConfig(BaseCustomResource):
    ...
    def create_from_yaml(self, yaml_data: dict) -> None:
        ...
        logger.info(
            'created nmstate config %s: %s', self.ref, pformat(yaml_data)
        )
    ...
    def create(
        ...
        logger.info(
            'created nmstate config %s: %s', self.ref, pformat(body)
        )
    ...
    def patch(
        ...
        logger.info(
            'patching nmstate config %s: %s', self.ref, pformat(body)
        )
